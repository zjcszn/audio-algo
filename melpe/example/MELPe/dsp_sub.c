...
{
	arm_fill_q15(fillval,output,npts);
}
...
{
	arm_fill_q31(fillval,output,npts);
}
...
void window(int16_t input[], const int16_t win_coeff[], int16_t output[],
			int16_t npts)
{
	arm_mult_q15((q15_t*)win_coeff, input,output,npts);
}
