...
/** @defgroup UART_PROTOCOL_INTERFACE UART_PROTOCOL_INTERFACE
  * @{
  */
...
/** @defgroup UART_PROTOCOL_INTERFACE_Define UART_PROTOCOL_INTERFACE_Define
  * @{
  */
...
/** @defgroup UART_PROTOCOL_INTERFACE_Private_Variables UART_PROTOCOL_INTERFACE_Private_Variables
  * @{
  */
...
ALIGN_32BYTES (uint8_t UART_RxBuffer[UART_RX_BUFFER_SIZE]);
ALIGN_32BYTES (uint8_t UART_TxBuffer[UART_TX_BUFFER_SIZE]);
...
/**
  ...
  */
uint8_t UART_ReceivedMSG(TMsg *Msg)
{
  ...
  if (UART_NewByte_idx != UART_PROTOCOL_CheckForNewData())
  {
    ...
    SCB_InvalidateDCache_by_Addr ((uint32_t*)UART_RxBuffer, UART_RX_BUFFER_SIZE);
...
/** @defgroup UART_PROTOCOL_INTERFACE_Private_Functions UART_PROTOCOL_INTERFACE_Private_Functions
  * @{
  */
