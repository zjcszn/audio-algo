...
/** @defgroup STM32XX_IT STM32XX_IT
  * @{
  */
...
/** @defgroup STM32XX_IT_Exceptions_Handlers STM32XX_IT_Exceptions_Handlers
  * @{
  */
...
/** @defgroup STM32XX_IT_Peripherals_Interrupt_Handlers STM32XX_IT_Peripherals_Interrupt_Handlers
  * @{
  */
