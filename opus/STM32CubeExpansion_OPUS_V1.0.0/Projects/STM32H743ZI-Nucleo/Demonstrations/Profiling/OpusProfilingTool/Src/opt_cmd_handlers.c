...
/** @defgroup OPT_CMD_HANDLERS OPT_CMD_HANDLERS
  * @{
  */
...
/** @defgroup OPT_CMD_HANDLERS_Define OPT_CMD_HANDLERS_Define
  * @{
  */
...
/** @defgroup OPT_CMD_HANDLERS_Private_Variables OPT_CMD_HANDLERS_Private_Variables
  * @{
  */
...
/** @defgroup OPT_CMD_HANDLERS_Exported_Functions OPT_CMD_HANDLERS_Exported_Functions
  * @{
  */
