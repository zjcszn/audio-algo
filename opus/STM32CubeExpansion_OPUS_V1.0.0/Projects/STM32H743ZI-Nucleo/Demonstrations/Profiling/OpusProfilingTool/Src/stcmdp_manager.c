...
/** @defgroup STCMDP_MANAGER STCMDP_MANAGER
  * @{
  */
...
/** @defgroup STCMDP_MANAGER_Private_Define STCMDP_MANAGER_Private_Define
  * @{
  */ 
...
/** @defgroup STCMDP_MANAGER_Private_Variables STCMDP_MANAGER_Private_Variables
  * @{
  */ 

static uint8_t PresentationString[] = {"OPT|NucleoH743_144|1.0.0"};
...
/** @defgroup STCMDP_MANAGER_Private_Function STCMDP_MANAGER_Private_Function
  * @{
  */
...
/** @defgroup STCMDP_MANAGER_Exported_Function STCMDP_MANAGER_Exported_Function
  * @{
  */
